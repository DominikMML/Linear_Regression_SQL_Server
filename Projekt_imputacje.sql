...
--b) Wyliczenie liczby braków zmiennej  BoilGravity, prcnt_lacks
DECLARE @n INT
...
-- Przed imputacją - Obliczamy statistics dla etapu z przed przeprowadzonia imputacji
...
-- statistics wy³ącznie wartoœci imputowanych - obliczamy statistics dla jednostek, które zosta³y poddane imputacji - braków
...
-- Zmienna po imputacji - obliczamy statistics dla wszystkich jednostek 
...
--imputo		2990	1,04	18,30	1,18	0,90	1,1		1,12		statistics imputowanych jednostek - braków
--po_imp		73861	 0		52,6	1,35	1,9		1,04	1,06		statistics  wraz z imputowanymi brakami
				-----------------------------------------------------
